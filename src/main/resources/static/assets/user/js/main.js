(function ($) {
    ...
    $(".hm-minicart-trigger").on("click", function (e) {
        ...
        var minicart = $(this).siblings(".minicart");
        if (minicart.is(":hidden")) {
            $(".minicart").slideUp(); // Đóng tất cả các minicart đang mở
            minicart.slideDown(); // Mở minicart hiện tại
            $(".hm-minicart-trigger").removeClass("is-active"); // Bỏ lớp is-active của tất cả các hm-minicart-trigger
            $(this).addClass("is-active"); // Thêm lớp is-active cho hm-minicart-trigger hiện tại
        } else {
            minicart.slideUp(); // Đóng minicart hiện tại
            $(this).removeClass("is-active"); // Bỏ lớp is-active của hm-minicart-trigger hiện tại
        }
    });
    ...
    $(".li-countdown").countdown("2019/12/01", function (event) {
        $(this).html(event.strftime('<div class="count">%D <span>Days:</span></div> <div class="count">%H <span>Hours:</span></div> <div class="count">%M <span>Mins:</span></div><div class="count"> %S <span>Secs</span></div>'));
    });
    /*----------------------------------------*/
    /* 09. Tooltip Active
	/*----------------------------------------*/
