...
public class UserController {
    ...
    public String index(Model model) {
        model.addAttribute("noiBat",
                restTemplate.get("https://klbstore.azurewebsites.net//rest/xinchao?hienThi=true&noiBat=true&sortBy=giamGiaGiamDan"));
        model.addAttribute("dienThoai",
                restTemplate.get("https://klbstore.azurewebsites.net//rest/xinchao?hienThi=true&sortBy=giaGiamDan"));
    ...
    public String checkout(Model model) {
        ...
        if (nguoiDung == null) {
            ...
            if (nguoiDung.getDiaChi() != null) {
                ...
                model.addAttribute("cart", restTemplate.get("https://klbstore.azurewebsites.net//checkoutCart?address="
    ...
    public String paymentVnpay(
        ...
        JsonNode map = restTemplate
                .get("https://klbstore.azurewebsites.net//checkoutSpecifiedCart?address=" + nguoiDung.getDiaChi()
    ...
    public String getProductDetails(@RequestParam("productId") Integer productId,
        ...
        model.addAttribute("chiTiet", restTemplate.get("https://klbstore.azurewebsites.net//rest/xinchao?hienThi=true&sanPhamId="
                + productId + "&tenSanPham=" + productName));
        model.addAttribute("sanPhamLienQuan",
                restTemplate.get("https://klbstore.azurewebsites.net//rest/hello?hienThi=true&related=" + productId));
        model.addAttribute("danhGias",
                restTemplate.get("https://klbstore.azurewebsites.net//rest/danhGia?sanPhamId=" + productId));
        ...
        if (nguoiDung != null) {
            model.addAttribute("canUserRateProduct",
                    restTemplate.get("https://klbstore.azurewebsites.net//rest/canUserRateProduct?sanPhamId=" + productId
    ...
    public String searchAndPage(Model model,
        ...
        model.addAttribute("pg", restTemplate.get("https://klbstore.azurewebsites.net//rest/sanpham?hienThi=true" + "&page=" + page
