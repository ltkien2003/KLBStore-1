...
public class ShoppingCartService {
    ...
    public String addToCart(Integer mauSacId, Integer soLuong) {
        ...
        JsonNode sanPhamDTO = restTemplate.get("https://klbstore.azurewebsites.net//rest/xinchao?hienThi=true&mauSacId=" + mauSacId)
                .get(0);
            ...
            if (cartItems != null) {
                for (ChiTietGioHangDTO cartItem : cartItems) {
                    ...
                    JsonNode sanPhamDTO = restTemplate
                            .get("https://klbstore.azurewebsites.net//rest/xinchao?hienThi=true&mauSacId="
